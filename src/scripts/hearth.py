...
class Hearth:
    def __init__(self, surface):
        ...
        self.hearth_img = pygame.transform.scale(pygame.image.load("graphics/ui/hearth.png"),(self.scale,self.scale))
        self.empty_hearth_img = pygame.transform.scale(pygame.image.load("graphics/ui/broken_hearth.png"),(self.scale,self.scale))
    def h3(self):
