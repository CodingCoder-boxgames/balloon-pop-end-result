...
class Game:
    def __init__(self, surface):
        self.game_font = pygame.font.Font("graphics/fonts/minecraft.ttf", 50)
        self.game_font_small = pygame.font.Font("graphics/fonts/minecraft.ttf", 25)
        self.back_button = pygame.image.load("graphics/ui/back_button.png")
        self.play_button = pygame.image.load("graphics/ui/play_button.png") 
        self.play_again_button = pygame.image.load("graphics/ui/play_again.png")
    ...
    def gameloop(self, paused):
        ...
        for i, balloon in enumerate(self.balloons):
            ...
            for player in self.players:
                if player.player.get_rect(topleft = (player.position[0], player.position[1])).colliderect(balloon.img.get_rect(topleft = (balloon.x_position, balloon.random_y_pos))):
                    self.balloons.pop(i)
                    pygame.mixer.Channel(1).play(pygame.mixer.Sound("graphics/sound_effects/balloon.wav"))
        ...
        if len(self.balloons) == 0 and self.game_over == False:
            self.level_up()
        if paused:
            self.surface.blit(pygame.image.load("graphics/ui/pause.png"), (0,0))
            self.draw_paused()
        self.draw_hearths()
    ...
    def draw_paused(self):
        ...
        # draw music thing
        self.surface.blit(pygame.image.load("graphics/ui/box.png"), (WIDTH - 180, 20))
    ...
    def shoot(self):
        if not self.game_over:
            ...
            pygame.mixer.Channel(2).play(pygame.mixer.Sound("graphics/sound_effects/shoot.wav"))
    ...
    def check_game_over(self):
        ...
        if not self.game_over:
            ...
            if self.lives == 0:
                self.game_over = True
                pygame.mixer.Channel(2).play(pygame.mixer.Sound("graphics/sound_effects/game_over.wav"))
