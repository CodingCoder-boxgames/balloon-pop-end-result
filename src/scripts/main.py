...
class Main:
    def __init__(self):
        ...
        self.can_shoot = True
        self.bg_count = 1
        self.path = 'graphics/background/background' + str(self.bg_count) + '.png'
        self.song = 1 
        self.music_path = "graphics/music/music" + str(self.song) + ".wav"
    ...
    def loop(self):
        ...
        while True:
            ...
            if self.game.game_over and not self.song_played:
                self.music_path = "graphics/music/game_over_music.wav"
                pygame.mixer.music.load(self.music_path)
                pygame.mixer.music.play(-1, 0.0)
